...
from evidxmusic import YouTube, app
from evidxmusic.core.call import Anony
from evidxmusic.misc import SUDOERS, db
from evidxmusic.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from evidxmusic.utils.decorators.language import languageCB
from evidxmusic.utils.formatters import seconds_to_min
from evidxmusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from evidxmusic.utils.stream.autoclear import auto_clean
from evidxmusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SUPPORT_CHAT,
    SOUNCLOUD_IMG_URL,
